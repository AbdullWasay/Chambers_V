...
const Sidebar = ({ onAddSection, onTemplates, onDesign, resumeSections, onRearrangeSections }) => {
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-item" onClick={handleRearrange}>
        <div className="sidebar-icon">
          <svg
            width="20"
            height="20"
      ...
      <div className="sidebar-item">
        ...
        <span>Check</span>
        <div className="badge green">OK</div>
      </div>
      ...
      {showRearrangeModal && (
        <RearrangeModal
          ...
          onRearrange={onRearrangeSections}
        />
      )}
    </div>
  )
